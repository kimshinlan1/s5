...
return [
    ...
    */
    ...
    'department_unique' => 'この部署名はすでに存在します。',
    'uploaded' => 'The :attribute failed to upload.',
    'url' => 'The :attribute must be a valid URL.',
    'uuid' => 'The :attribute must be a valid UUID.',

    'uppercase' => ':attributeは大文字である必要があります。',
    'restrict_delete' => 'この:attributeはすでにシステムで使用されており、削除できませんでした。',
    'password_special_character' => ':attributeには、少なくとも1つの特殊文字が含まれている必要があります。',
    'password_alpha_num' => ':attributeには、少なくとも1つの文字と数字が含まれている必要があります。',
    'password_half_width' => ':attributeは半角文字である必要があります',
    'password_does_not_match' => ':attributeが古いパスワードと一致しません。',
    'email_registered' => ':attributeはすでに登録されています',
