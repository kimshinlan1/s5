                    ...
                    <div class="input-group" style="margin-bottom: 0.5%;">
                        ...
                        <div class="date">
                            <input type="text" class="form-control" id="dateCreate" placeholder="yyyy年MM月dd日"
                                ...
                                title="{{ __('Common_Click_To_Select_Date') }}" value="{{ isset($info['created_at']) ? $info['created_at'] : '' }}">
                        </div>
                    </div>
                    <div class="input-group">
                        ...
                        <div class="date">
                            <input type="text" class="form-control" id="dateUpdate" placeholder="yyyy年MM月dd日"
                                ...
                                title="{{ __('Common_Click_To_Select_Date') }}" value="{{ isset($info['updated_at']) ? $info['updated_at'] : '' }}">
                        </div>
                    </div>
                </div>
            </div>
