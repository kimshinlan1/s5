...
<div id="confirmDialog3" class="modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="okDialog3Btn" value="" data-deptid="" data-patternid="" data-isPattern="" data-compId="" data-bs-dismiss="modal">{{ __('Common_button_ok') }}</button>
