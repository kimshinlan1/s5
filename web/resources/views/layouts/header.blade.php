<div class="header">
    <nav class="navbar navbar-expand-md navbar-light px-4" id="navbar">
        ...
        <a id="freeLabelId" class="navbar-brand freeLabelId" href="https://kaizen-base.com/" target="_blank" style="display: flex; margin-left: 1rem;background: #f4b183; font-size: 0.7rem; padding: 0.2rem; text-align: left;" hidden>
            <div>
