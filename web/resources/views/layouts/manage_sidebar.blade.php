<div class="sidebar" style="display: none;">
    <div class="list-group list-group-flush">
        <!-- Home -->
        <a href="/" id="mainMenuTop" onclick = hideCollapse() aria-expanded="false" style="background-color: #BFBFBF" class=" d-flex justify- list-group-item list-group-item-action">{{__('Main_Menu_Top')}}</a>
        <!-- Management -->
        <a id="mainMenu1" href="javascript:void(0);" data-toggle="collapse" aria-expanded="false" style="background-color: #BFBFBF" class="list-group-item list-group-item-action menu" onclick="toggleMenu(1)">
        ...
        <!-- Study Plan -->
        <a id="mainMenu2" href="#" data-toggle="collapse" aria-expanded="false" style="background-color: #BFBFBF" class="list-group-item list-group-item-action menu" onclick="toggleMenu(2)">
            <div class="d-flex w-100 justify-content-between align-items-center">
        ...
        <!-- Skill Map -->
        <a id="mainMenu3" href="javascript:void(0);" data-toggle="collapse" aria-expanded="false" style="background-color: #BFBFBF" class="list-group-item list-group-item-action menu" onclick="toggleMenu(3)">
            <div class="d-flex w-100 justify-content-between align-items-center">
        ...
        <!-- 5S Management -->
        <a id="mainMenu4" href="javascript:void(0);" data-toggle="collapse" aria-expanded="false" style="background-color: #BFBFBF" class="list-group-item list-group-item-action menu" onclick="toggleMenu(4)">
            <div class="d-flex w-100 justify-content-between align-items-center">
