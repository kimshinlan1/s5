    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="deletePatternListId" class="form-control" id="deletePatternListId" value="">
                <div class="message"></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="deletePatternListBtn">{{ __('Common_button_ok') }}</button>
