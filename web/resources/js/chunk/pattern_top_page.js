    ...
    datasets: [
      {
        ...
        data: avgPointArr[0],
        fill: true,
        backgroundColor: 'rgba(255, 99, 129, 0.3)',
        borderColor: 'rgba(255, 99, 129, 1)',
        pointBackgroundColor: 'rgba(255, 99, 129, 0.3)',
        pointBorderColor: '#fff',
        pointHoverBackgroundColor: '#fff',
        pointHoverBorderColor: 'rgba(255, 99, 129, 1)',
      },
      {
        ...
        borderColor: 'rgba(0, 155, 232, 1)',
        pointBackgroundColor: 'rgba(0, 155, 232, 0.3)',
        pointBorderColor: '#fff',
        pointHoverBackgroundColor: '#fff',
        pointHoverBorderColor: 'rgba(0, 155, 232, 1)',
      },
      {
        label: CONFIG.get('THIRD_CHART_LABEL'),
        data: avgPointArr[2],
        fill: true,
        backgroundColor: 'rgba(254, 159, 77, 0.3)',
        borderColor: 'rgba(254, 159, 77, 1)',
        pointBackgroundColor: 'rgba(254, 159, 77, 1)',
        pointBorderColor: '#fff',
        pointHoverBackgroundColor: '#fff',
        pointHoverBorderColor: 'rgba(254, 159, 77, 1)',
      },
