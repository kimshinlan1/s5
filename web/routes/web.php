...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['transaction']], function () {
        ...
        Route::post('/pattern_list/check_inspection_binding', [PatternController::class, 'checkContainInspection']);
        ...
        Route::get('/pattern_dept_setting_check_data_used/{id}', [PatternDeptSettingController::class, 'checkDataUsed']);
        Route::post('/pattern_dept_setting/check_binding', [PatternDeptSettingController::class, 'checkBinding']);
        ...
        Route::post('/pattern_team_inspection/evidence/removeBLocks', [PatternTeamInspectionController::class, 'removeBlock']);
        ...
        Route::get('/pattern_top_page/check_dept_exist', [PatternTopPageController::class, 'checkDeptExist']);
